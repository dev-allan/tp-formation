 ...
 */
final class Version20220525074917 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE promotion (id INT AUTO_INCREMENT NOT NULL, formateur_id_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, INDEX IDX_C11D7DD1A2FE286F (formateur_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
